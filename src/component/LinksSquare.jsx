...
export default function LinksSquare() {
  ...
  return (
    <div className="gap-5  h-full mx-auto flex items-center justify-evenly ">
      ...
      <div className="w-16 h-16 rounded-lg bg-neutral-50 p-2 shadow-md delay-200 animate-[aparecer_3s]">
        <svg
          className="w-full h-full fill-cyan-600"
          viewBox="0 0 24 24"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="w-16 h-16 rounded-lg bg-neutral-50 p-2 shadow-md delay-200 animate-[aparecer_4s]">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          className="w-full h-full fill-cyan-600"
