...
export default function DatosPersonales() {
  return (
    <SectionOutlet>
      <div className="relative flex flex-col min-w-0 break-words w-full  shadow-lg rounded-lg bg-zinc-100 border-0">
              ...
              <div className="w-full lg:w-6/12 px-4">
                <div className="relative w-full mb-3">
                  ...
                  <input
                    ...
                    placeholder="RamiroChangomoreno"
                  />
                </div>
              </div>
              <div className="w-full lg:w-6/12 px-4">
...
/                  >
            ...
            <button  className="bg-gray-700 rounded-sm px-3 py-1.5 text-gray-50 font-semibold">Guardar</button>
          </form>
        </div>
      </div>
    </SectionOutlet>
