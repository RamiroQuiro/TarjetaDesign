...
export default function Login() {
  return (
    <div className="w-screen h-screen bg-rose-900 flex items-center justify-center overflow-hidden absolute">
      ...
      <section
        className="bg-white h-[480px] w-[400px]  relative flex items-center justify-center before:content-[' '] before:absolute before:top-0 before:left-0 before:w-6 before:h-full before:bg-gradient-to-t before:to-gray-50 before:from-gray-400 before:backdrop-blur-sm before:z-10
     after:content-[' '] after:absolute after:top-0 after:right-0 after:w-6 after:h-full after:bg-gradient-to-t after:to-gray-50 after:from-gray-400 after:backdrop-blur-sm after:z-10 
     "
        s
      >
        {/* sombra */}
      ...
      after:content-[' '] after:absolute after:bottom-[-200%] after:left-[calc(100%+80px)] after:w-[100%] after:h-[200%] after:bg-gradient-to-t after:to-black/30 after:from-transparent after:skew-x-[45deg]
      "
        ></div>
        {/* fondo formulario */}
        <div
          className="w-full relative h-full bg-gradient-to-t to-gray-50 via-gray-200 from-gray-400 shadow-xxxl flex items-center justify-center"
        >
          {/* formulario */}
          <form className="px-10 py-5  w-10/12 flex flex-col justify-between items-center h-full  ">
              ...
              <div className="flex flex-col  items-start justify-between w-full relative my-2">
                <input type="text" name="useName" id="userName" required className="peer w-full py-3 pl-8 bg-transparent shadow-none border-0 border-b-2 text-gray-700 border-gray-500 outline-none focus:outline-none relative" />
                <FontAwesomeIcon icon={faUser} className="text-gray-700 absolute left-0 bottom-3 h-2/5" /> 
                <label htmlFor="userName" className=" peer-focus:bg-gray-700 peer-focus:text-gray-50  peer-focus:p-1 peer-focus:rounded-sm peer-focus:-translate-y-8 peer-valid:bg-gray-700 peer-valid:text-gray-50  peer-valid:p-1 peer-valid:rounded-sm peer-valid:text-xs peer-focus:text-xs peer-valid:-translate-y-8 duration-500 text-gray-700 absolute left-0 bottom-3 pl-8 ">Nombre de Usuario</label>
              </div>
              <div className="flex flex-col  items-start justify-between w-full relative  my-2">
              <input type="password" name="password" id="password"  required className="peer w-full py-3 pl-8 bg-transparent shadow-none border-0 border-b-2 text-gray-700 border-gray-500 outline-none focus:outline-none relative" />
              ...
              <button className="bg-gray-700 rounded-sm px-3 py-1.5 text-gray-50 font-semibold">Ingresar</button>
          </form>
        </div>
      </section>
    </div>
